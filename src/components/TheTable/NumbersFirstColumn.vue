<template>
    <div class="first-column columns">
        <div v-for="item in number_first_column" :class="`form-check form-check-inline ${disabled_btn}`" :key="item.name">
...
export default {
    computed: {
        number_first_column() {
            return this.$store.state.initialState.number_first_column
        },
        disabled_btn() {
